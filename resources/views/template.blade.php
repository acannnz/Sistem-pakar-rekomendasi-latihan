        ...
        <nav class="bg-white border-gray-200 dark:bg-gray-900">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul class="font-medium flex flex-col md:items-center md:justify-center p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-16 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <a href="#hero" class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500" aria-current="page">Home</a>
                        </li>
                        <li>
                        ...
                        <li class="">
                            <a href="{{ url('index') }}" class="inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:text-white dark:focus:ring-cyan-800">
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-10">
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                ...
                <div class="hover:bg-gray-800 hover:rounded-md p-2 duration-300">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Peningkatan Kebugaran Jangka Panjang</h3>
                    <p class="text-gray-500 dark:text-gray-400"> Sistem ini tidak hanya membantu pemula mencapai tujuan kebugaran, tetapi juga mendukung mereka untuk mempertahankan gaya hidup sehat dan kebugaran yang berkelanjutan.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
                <div href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src="{{asset('image')}}/logo.png" class="h-14 w-1h-14" alt="Logo" />
                    <span class="self-center text-2xl whitespace-nowrap font-punch dark:text-yellow-100">OTW SAITAMA</span>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul class="text-gray-500 dark:text-gray-400 font-medium">
                            <li class="mb-4">
                                <a href="https://laravel" class="hover:underline">Laravel 11</a>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul class="text-gray-500 dark:text-gray-400 font-medium">
                            <li class="mb-4">
                                <a href="https://github.com/acannnz/Sistem-pakar-rekomendasi-latihan" class="hover:underline ">Github</a>
                            </li>
                            <li>
                                <a href="https://discord.gg/hahahaha" class="hover:underline">Discord</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" class="hover:underline">Sistem Pakar™</a>. All Rights Reserved.
                </span>
